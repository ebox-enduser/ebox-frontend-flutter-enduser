...
class SettingController extends GetxController {
  ...
  Rxn<UserLocation> userLocation = Rxn<UserLocation>();
  ...
  void createUserLocation(
    ...
    try {
      ...
      var userResult = await UserLocationService().createUserLocation(
          token: token,
          address: address,
  ...
  void getUserLocation() async {
    try {
      ...
      var userResult = await UserLocationService().getUserLocation(
        token: token,
      );
      if (userResult.statusCode == 200) {
        userLocation.value = userLocationFromJson(userResult.body);
